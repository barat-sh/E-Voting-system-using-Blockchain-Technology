<%-- 
    Document   : NomineeLogin
    Created on : Sep 13, 2019, 2:31:08 PM
            ...
            <div id="content-wrap">
                <div id="main"> <a name="TemplateInfo"></a>
                    ...
                    <%!
                        ResultSet rs;
                    %>
                    <form name="form1" action="NomineeLogin.jsp" method="POST">
                        <table cellspacing="10" align="center">
                            <tr>
                                <th colspan="2" style="font-size: 20px;">Nominee Login</th>
                            </tr>
                            <tr>
                                <td>Nominee Id</td>
                    ...
                    <%
                        if (request.getParameter("t1") != null) {
                            ...
                            ps=con.prepareStatement("select * from NomineeRegistration where nominee_id=? and password=?");
                            ps.setString(1, voter_id);
                            ps.setString(2, pwd);
                            rs=ps.executeQuery();
                            if(rs.next()){
                                session.setAttribute("NomineeId", voter_id);
                                response.sendRedirect("NomineeHome.jsp");
                            }
                            else{
