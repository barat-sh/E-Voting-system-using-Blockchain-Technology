<%-- 
    Document   : NomineeInfo
    Created on : Sep 26, 2019, 4:35:29 PM
            ...
            <div id="content-wrap">
                <div id="main"> <a name="TemplateInfo"></a>
                    ...
                    <%!
                        ...
                        int nominee_id;
                    %>
                    <span style="margin-left: 350px;"><a style="color:blue;font-size: 12px;font-weight: bold;" href="ViewSelectedNominees.jsp">Click to View Selected Nominees</a></span>
                    <table cellspacing="10">
                        <tr>
                            <th colspan="4" style="font-size: x-large;">View Nominee Info</th>
                        </tr>
                        <tr>
                            <th>Nominee Id</th>
                            <th>Nominee Name</th>
                    ...
                    <tr>
                        ...
                        <td><a href="NomineeFullView.jsp?nominee_id=<%=nominee_id%>" style="color: blue;">Full View</a></td>
                    </tr>
                    <%
                        }
                        rs.close();
