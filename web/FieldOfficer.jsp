<%-- 
    Document   : FieldOfficer
    Created on : Sep 13, 2019, 2:31:00 PM
            ...
            <div id="content-wrap">
                <div id="main"> <a name="TemplateInfo"></a>
                    ...
                    <%!
                        ResultSet rs;
                    %>
                    <form name="form1" action="FieldOfficer.jsp" method="POST">
                        <table cellspacing="10" align="center">
                            <tr>
                                <th colspan="2" style="font-size: 20px;">Field Officer Login</th>
                            </tr>
                            <tr>
                                <td>User Id(Field Officer)</td>
                    ...
                    <%
                        if (request.getParameter("t1") != null) {
                            ...
                            ps=con.prepareStatement("select * from FieldOfficer where userid=? and password=?");
                            ps.setString(1, userid);
                            ps.setString(2, pwd);
                            rs=ps.executeQuery();
                            if(rs.next()){
                                session.setAttribute("FieldOfficerId", userid);
                                response.sendRedirect("FieldOfficerHome.jsp");
                            }
                            else{
