<%-- 
    ...
    Created on : Oct 15, 2019, 3:09:38 PM
        ...
        <div id="wrap">
            ...
            <div id="content-wrap">
                <div id="main"> <a name="TemplateInfo"></a>
                    <h1>E-Voting</h1>
                    <% 
                        ps=con.prepareStatement("delete from electiondate");
                        ps.executeUpdate();
                        ps.close();
                        
                        ps=con.prepareStatement("delete from nomineeRegistration");
                        ps.executeUpdate();
                        ps.close();
                        
                        ps=con.prepareStatement("delete from VotedStatus");
                        ps.executeUpdate();
                        ps.close();
                        ...
                        ps=con.prepareStatement("delete from electionResult");
                        ps.executeUpdate();
                        ps.close();
