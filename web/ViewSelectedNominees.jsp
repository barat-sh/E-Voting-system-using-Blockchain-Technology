<%-- 
    Document   : ViewSelectedNominees
    Created on : Oct 15, 2019, 3:24:07 PM
            ...
            <div id="content-wrap">
                <div id="main"> <a name="TemplateInfo"></a>
                    ...
                    <table cellspacing="10">
                        <tr>
                            <th colspan="6" style="font-size: x-large;">View Selected Nominee Info</th>
                        </tr>
                        <tr>
                            <th>Nominee Id</th>
                            <th>Nominee Name</th>
                    ...
                    <%
                        ps=con.prepareStatement("select * from NomineeRegistration where status='Accepted'");
                        rs=ps.executeQuery();
                        while(rs.next()){
